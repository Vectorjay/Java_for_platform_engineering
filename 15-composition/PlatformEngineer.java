public class PlatformEngineer extends Employee{
    ...
    public PlatformEngineer(String name, String role, int age, int experience, double salary, int kubernetesExperience, Department department) {
    ...
    public String describeRole() {
        return "Manages infrastructure and Kubernetes platforms";
    }
